...
<div class="rightal"><a href="reset_db.php?source=sqlinjection_2" title="Resetta Database">Reset Database</a></div>
<h2><a href="#">SQL Injection #2</a></h2>
<div class="articles">
This is a message board. Add your message inside the form below. <br /><br />
<span style="color: blue;font-weight:bold;">Goal: execute a sql injection attack following this procedure:
<ul style="padding-left:15px;">
  <li>Guess db name</li>
  <li>Guess user table name</li>
  <li>Guess username</li>
  <li>Guess password</li>
</ul>
</span>
<form action="index.php?p=sqlinjection_2" method="POST">
